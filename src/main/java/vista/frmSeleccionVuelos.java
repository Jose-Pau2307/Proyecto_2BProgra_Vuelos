...
public class frmSeleccionVuelos extends JFrame {
    ...
    private void mostrarResumenFinal(List<String> asientosSeleccionados) {
        ...
        if (opcion == JOptionPane.OK_OPTION) {
            // MODIFICACIÓN: Abrir el registro de pasajeros
            frmDatosPasajeros registro = new frmDatosPasajeros(
                    vueloSeleccionado, // Ida
                    null, // Vuelta (no hay)
                    asientosSeleccionados, // Asientos Ida
                    null, // Asientos Vuelta (no hay)
                    claseSeleccionada, // Clase Ida
                    "", // Clase Vuelta
                    adultos, ninos, bebes,
                    totalPagar
            );
